    ...
    >
      ...
      <div className="backdrop-blur-md flex flex-col">
        ...
        <div className="rounded-2xl bg-purple-300/25 p-4">
          ...
          <p>
            It&apos;s a very simple-to-use (in my opinion) web browser app.
            Today&apos;s web browser are very complicated to set. For example,
            for just change the default search engine , you need to navigate
            into multiple menu, like this:
            <code>
              tap to the settings icon {"> "}
              search the search engine option, then tap on this setting {
                "> "
              }{" "}
              then tap again to finally change the search engine set by default
            </code>
            ... So yeah, this app as proper goal: to simplify all menus of a web
            browser app.
          </p>
        </div>
      </div>
